                        ...
                        <div class="brands_products"><!--brands_products-->
                            <div class="brands-name">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    @foreach($cats as $cat)
                                        <li class="brandLi"><input type="checkbox" id="brandId"
                                                                   value="{{$cat->id}}"
                                                                   class="try"/>
                                            <span class="pull-right">({{App\products::where('cat_id',$cat->id)->count()}}
                                                )</span>
                                        ...
                                        <div class="productinfo text-center">
                                            ...
                                            <h2 id="price">
                                                @if($product->spl_price==0)
                                                    ${{$product->pro_price}}
                                                @else
                                                    <img src="{{Config::get('app.url')}}theme/images/shop/sale.png"
                                                         style="width:60px"/>
                                           ...
                                           ${{$product->pro_price}} </span>
                                            ...
                                            <p>
                                                <a href="{{url('/product_details')}}"><?php echo $product->pro_name; ?></a>
                                            </p>
