...
public function checkODDl(Request $request)
{
    ...
    if ($request->session()->get('username') !=null) {
        ...
        $orders = DB::select("select * from orderdetail,products where orderdetail.ID={$idOrder} and orderdetail.ProductID=products.ID");
...
public function checkSODA(Request $request){
        ...
        $orders = DB::select("select * from orderdetail,products where orderdetail.ID={$orderID} and orderdetail.ProductID=products.ID");
